...
**Code milestone:** ENGINE-0 token generator and complete ENGINE-1 tiny
autoregressive inference engine.
**Conceptual milestone:** follow one token from input bytes through logits,
sampling, feedback, and streamed output.
...
| 4. Logits, Sampling, and the Autoregressive Loop | COMPLETE | [Chapter](chapter-04-logits-sampling-autoregressive-loop.md), [complete ENGINE-1](../../code/mini-engine/README.md), [Labs 9–15](../../docs/LABS.md) |
